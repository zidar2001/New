<template>
  <div>
    ...
    <section class="w-full text-gray-700 body-font ">
      ...
      <div class="flex justify-between container px-8 mx-auto pb-6 pt-4">
        <div>
            <button
...
<div class="flex justify-end">
          ...
          <div class="pt-2 pb-4 absolute mt-12 border-2 border-teal-400 bg-white right-0 pl-16  pr-16 z-10 "
            ...
            <div class="flex pl-12 space-x-10 pt-32">
              <button class="no-underline border-2 rounded-lg p-2 border-green-300 shadow-md hover:bg-green-300"
                      @click="reset">RESET
              </button>
              <button class="no-underline border-2 rounded-lg p-2 border-green-300 shadow-md hover:bg-green-300"
                      @click="changeStatement">SHOW RESULTS
              </button>
            </div>
          </div>
        </div>
            ...
            <div class="" v-for="house in houses" :key="house.id"
              ...
              <div class="card_dec">
                ...
                <div class="card_padding">
                  ...
                  <div class="flex justify-between">
                    <div class="address_trunc">{{ house.address }} {{ house.address2 }}</div>
                    <div class="flex justify">
                      <div class="flex mx-2">
                        <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24"
                             viewBox="0 0 24 24" width="24">
                      ...
                      <div class="flex justify">
                        ...
                        <span class="bathrooms_icon">{{ house.bathrooms }}</span>
                      </div>
                    </div>
                  </div>
                  <button
                  ...
                  <button class="single_open_locked"
                          v-else-if="house.locked===1">Open
                  </button>
                </div>
              </div>
